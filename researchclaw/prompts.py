...
_DEFAULT_STAGES: dict[str, dict[str, Any]] = {
    ...
    "topic_init": {
        ...
        "user": (
            ...
            "- Name the specific benchmark, dataset, cohort, registry, or data "
            "resource that will be used for evaluation.\n"
            "- If no standard benchmark exists, explain how results will be "
            "measured without forcing an ML leaderboard framing.\n"
            "- For biomedical, epidemiology, clinical, or grant-proposal topics, "
            "use cohort outcomes, external validation, calibration, effect sizes, "
            "and public-health value instead of SOTA/leaderboard language.\n"
            "- Add a 'Benchmark/Data Resource' subsection listing: name, source, "
            "and typical metrics — omit unverified performance numbers."
        ),
    },
    "problem_decompose": {
    ...
    "search_strategy": {
        ...
        "user": (
            ...
            "The YAML MUST include top-level search_strategies, each containing "
            "a queries list. Stage 4 reads search_strategies[*].queries directly; "
            "if you also include merged_queries or database-specific queries, "
            "duplicate the best executable queries into search_strategies.\n"
            "For biomedical or grant-proposal topics, prefer PubMed/OpenAlex-"
            "friendly English keyword queries covering cohorts, exposures, "
            "outcomes, biomarkers, risk prediction, validation, and recency. "
            "Do not add generic ML terms such as benchmark, SOTA, or deep learning "
            "unless the topic explicitly requires them.\n"
    ...
    "literature_screen": {
        ...
        "user": (
            ...
            "2. METHOD RELEVANCE: The paper must discuss methods, cohorts, "
            "datasets, endpoints, biomarkers, prediction metrics, validation "
            "designs, or findings directly applicable to the research topic.\n"
